...
const systems = [
  ...
  },
  {
    ...
    img: "https://res.cloudinary.com/dwa3soopc/image/upload/v1782650905/governance_gnblzb.png",
    href: "/SystemMasters/governance-framework",
  },
  {
        ...
        <div className="container-custom px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {systems.map((system) => {
              const cardContent = (
                <>
                  ...
                  <div className="p-6">
                    ...
                    {system.href && (
                      <p className="mt-3 text-xs font-semibold text-accent-600 group-hover:text-accent-700 inline-flex items-center gap-1">
                        Learn more
              ...
              const className = `card overflow-hidden bg-gradient-to-br ${system.color} border-2 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group`;

              return system.href ? (
                <Link key={system.title} href={system.href} className={className}>
                  {cardContent}
                </Link>
              ) : (
                <div key={system.title} className={className}>
                  {cardContent}
                </div>
              );
            })}
