        ...
        <div className="container-custom px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {systems.map((system) => (
              <div
                key={system.title}
                className={`card p-7 bg-gradient-to-br ${system.color} border-2 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group`}
              >
                <div className={`w-13 h-13 w-12 h-12 rounded-xl flex items-center justify-center mb-5 ${system.iconColor} group-hover:scale-110 transition-transform duration-300`}>
                  {system.icon}
                </div>
                <h3 className="text-lg font-display font-bold text-neutral-900 mb-3 leading-snug">
                  {system.title}
                </h3>
